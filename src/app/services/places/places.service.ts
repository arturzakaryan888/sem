...
export class PlaceService {
  ...
  getAllPlaces= () => {
    return this.http.get('places?fields=id,name,crs_id,crs.name,crs.id,u_speed,population,square,stratification_coefficient,air_density,relief_coefficient,avg_temperature_of_could_month,avg_temperature_of_warm_month,background_mode&expand=crs');
  }
  getAllPlacesWithCrs = () => {
